...
non_completed_certs = df_training_compliance[
...
am_no_completed_certs = no_esop.merge(
    non_completed_certs[['employee_id']].drop_duplicates(),
    on='employee_id',
    how='inner'
)

result = (
    am_no_completed_certs[

...
uncertified_records = df_training_compliance[
...
uncertified_emp_ids = set(uncertified_records['employee_id'].dropna())

result = (
    no_esop[no_esop['employee_id'].isin(uncertified_emp_ids)][

...
am_with_cert_gap = cert_gap[['employee_id']].drop_duplicates()
...
result = pd.merge(
    ...
    'level',
    'job_title'
]].drop_duplicates(subset=['customer_id']).sort_values('arr_inr_lakhs', ascending=False).reset_index(drop=True)